...
(function () {
   ...
   // renderRadialBarChart("#network-Usage", [79], ["#28ccee", "#28ccee"], colors.headingColor);
	...
	$.ajax({
		url: window.location.origin+"/index.php/apps/cloudfloat/gettotalmetrics",
		method: 'POST',
		data: {},
		dataType: 'json',
...
$('#MemoryUsage').show();
	...
	// Check and render the chart for the first ID
	  ...
	  var options  = {
		...
		chart.render();
	  $.ajax({
			  url: window.location.origin+"/index.php/apps/cloudfloat/getallmetrics",
			  method: 'POST',
			  data: {
			  'chart_type':'cpu',
			 'pod':$('#cpu_pod').val(),
...
let d5 = document.querySelector("#fileactivityChart");
	...
	$.ajax({
		url: window.location.origin+"/index.php/apps/cloudfloat/getactivity",
		method: 'POST',
		data: {
		'chart_type':'input',
...
var j=1;
$.ajax({
	url: window.location.origin+"/index.php/apps/cloudfloat/allevents",
	method: 'GET',
	data: {
	'pod':pod,
	'periods':periods,
...
$.ajax({
	url: window.location.origin+"/index.php/apps/files/api/v1/stats",
	method: 'GET',
	data: {
	'user':1,
	},
...
var j=0;
$.ajax({
	url: window.location.origin+"/index.php/apps/cloudfloat/getapps",
	method: 'POST',
	data: {
	'user':1,
	},
